...
INSERT INTO `deletedmembertbl` VALUES ('Dang','당탕이','경기 부천시 중동','2018-07-03');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_deletedMemberTBL
	AFTER DELETE
    ON memberTBL
    FOR EACH ROW
BEGIN
...
-- Dump completed on 2018-07-03 15:35:32
